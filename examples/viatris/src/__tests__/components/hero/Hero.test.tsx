...
import { Default as Hero, ImageBackground, OfferingsGrid } from '@/components/hero/Hero';
...
jest.mock('@/components/hero/HeroOfferingsGrid.dev', () => ({
  HeroOfferingsGrid: () => <section data-testid="hero-offerings-grid" />,
}));
...
describe('Hero Component', () => {
  ...
  it('renders the OfferingsGrid variant correctly', () => {
    render(<OfferingsGrid {...mockHeroProps} />);
    expect(screen.getByTestId('hero-offerings-grid')).toBeInTheDocument();
  });
});
