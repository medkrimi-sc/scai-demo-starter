...
import { AccordionBlockSimpleRows } from './AccordionBlockSimpleRows.dev';
...
export const SimpleRows: React.FC<AccordionProps> = (props) => {
  const { isEditing } = props.page.mode;

  return <AccordionBlockSimpleRows {...props} isPageEditing={isEditing} />;
};
