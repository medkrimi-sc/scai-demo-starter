...
export const IaSearchBox: React.FC<IaSearchBoxProps> = ({ variant = 'desktop', className }) => {
  ...
  return (
    <div ref={ref} className={cn('relative', className)}>
      ...
      >
        <div className="p-4">
          <p className="mb-3 text-sm font-medium text-[#703E97]">
          ...
          <div className="flex gap-2">
            <input
              ...
              className="w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 placeholder:text-gray-500 focus-visible:ring-2 focus-visible:ring-[#703E97] focus-visible:outline-none"
              value={searchTerm}
