...
module.exports = {
    ...
    theme: {
        extend: {
            ...
            backgroundImage: {
                'light-gradient':
                    'linear-gradient(to bottom, #ffffff 0%, rgba(112, 62, 151, 0) 100%)',
                'primary-gradient':
                    'linear-gradient(179.89deg, #703E97 0.1%, rgba(42, 39, 110, 0) 115.08%)',
                'dark-gradient': 'linear-gradient(to bottom, #f5f3f7 0%, rgba(42, 39, 110, 0) 100%)',
                'img-primary':
