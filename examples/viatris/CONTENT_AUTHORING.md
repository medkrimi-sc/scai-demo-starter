...
No. IA branches live under **Templates → Branches → click-click-launch → Viatris**:
...
Solterra’s **Add Article Page** branch is for the Solterra demo site only. Do not use it on Viatris.
...
Push **click-click-launch first** (templates and branches), then **viatris** (content).
