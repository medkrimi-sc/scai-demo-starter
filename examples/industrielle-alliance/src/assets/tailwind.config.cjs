...
module.exports = {
    ...
    theme: {
        extend: {
            ...
            backgroundImage: {
                'light-gradient':
                    'linear-gradient(to bottom, #ffffff 0%, rgba(0, 86, 179, 0) 100%)',
                'primary-gradient':
                    'linear-gradient(179.89deg, #0056b3 0.1%, rgba(0, 86, 179, 0) 115.08%)',
                'dark-gradient': 'linear-gradient(to bottom, #e8eef5 0%, rgba(0, 26, 51, 0) 100%)',
                'img-primary':
