...
/**
 * Uses next/link for internal routes in preview/live (avoids locale={false} on <a>).
 * Falls back to Content SDK Link in the editor when field metadata is present.
 */
