# iA Financial Group — design token mapping (industrielle-alliance)

Reference: live [ia.ca](https://www.ia.ca/) (DevTools computed styles — refine after deploy) and homepage layout brief.
...
- Marketing headings on ia.ca are **smaller** than the previous starter’s display scale; base `h1`–`h4` rules were tightened in `src/app/globals.css`.
